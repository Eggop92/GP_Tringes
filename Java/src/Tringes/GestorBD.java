...
public class GestorBD {
	...
	//CONSTRUCTORES
	    ...
	    private GestorBD() {
	    		...
	    		//poner los datos apropiados
	  	      	this.usuario = "Tringes"; //usuario creado en MySQL y con permiso en la Base de
	  	        //datos con la que quiero trabajar. Hay que evitar usar el root
	  	      	this.clave = "Tringes"; //Password de mysql del usuario
	  	        this.url = "jdbc:mysql://localhost:3306/tringes"; //Forma de "encontrar" la Base de Datos en
	...
	/**Métodos para trabajar con la Base de Datos. En este caso he puesto cuatro métodos
	  y los cuatro trabajan con el objeto ResulSet. Hay más opciones, las podéis consultar
	  en la documentación de java.sql y usarlas en función de vuestras necesidades
	 **/
